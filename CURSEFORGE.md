...
- `worldwipe.help` - Show WorldWipe commands in the native help UI

Admin control:
- `worldwipe.admin` - Required for schedule edits, force wipe, reload, and admin UI actions

Schedule visibility:
- `worldwipe.schedule` - Allow viewing schedules (read-only)
- `worldwipe.schedule.<world>` - Allow viewing a specific world
